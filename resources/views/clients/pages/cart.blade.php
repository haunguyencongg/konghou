                                        ...
                                        <tr>
                                            ...
                                            <td class="cart-product-image">
                                                <a href="javascript:void(0)">
                                                    <img src="{{ asset('storage/' . ($item['image'] ?? 'uploads/products/product-default.png')) }}"
                                                        alt="Sản phẩm"></a>
                                            </td>
                                            ...
                                            <td class="cart-product-subtotal">{{ number_format($subtotal, 0, ',', '.') }} ₫</td>
                                        </tr>
                                    @empty
                                        <tr>
                            ...
                            <table class="table">
                                <tbody>
                                    <tr>
                                        ...
                                        <td><span class="cart-total">{{ number_format($cartTotal, 0, ',', '.') }} ₫</span></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><strong><span class="cart-grand-total">{{ number_format($cartTotal + 25000, 0, ',', '.') }} ₫</span></strong></td>
                                    </tr>
                                </tbody>
                            </table>
